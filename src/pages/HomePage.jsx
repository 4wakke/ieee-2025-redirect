...
function HomePage() {
  ...
  return (
    <div className="home flex items-center justify-center px-4 min-h-[85vh] w-full mx-auto lg:mt-2 md:mt-4 sm:mt-4 mt-6">
  <div className="bg-[#2a4992] bg-opacity-90 w-full max-w-[850px] rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col items-center justify-center text-center">
    ...
    <Link to="/register">
      <button className="bg-white text-[#4067a5] font-semibold rounded-md hover:bg-[#5c75a8] text-lg  hover:text-white transition-all duration-300 shadow-md hover:shadow-lg tracking-wide py-3 px-7 mb-2">
        Registrarse
      </button>
    </Link>
